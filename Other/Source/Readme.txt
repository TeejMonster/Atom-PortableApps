...
user in an INI file next to AtomPortable.exe called AtomPortable.ini.
...
copy AppNamePortable.ini from this directory to AtomPortable.ini next to
AtomPortable.exe. The options in the INI file are as follows:
